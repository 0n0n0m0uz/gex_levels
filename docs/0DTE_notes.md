...
Black Scholes will not correctly w timeframes under 15 min to expiration because the denominator shrinks faster than numerator and therefore gamma approaches infinity and you get errors so other functions are used or just stop 
...
8. Multiply each contracts gamma by the contracts oi which scales up the gamma to represent the total hedging pressure on for all those contracts on the dealers books
9 gamma x oi x 100 x spot squared x .01 gives you dollar notional or the dollar amount dealers need hedge for a 1% move.  This lets you compare different priced stocks and their effect on hedging pressure